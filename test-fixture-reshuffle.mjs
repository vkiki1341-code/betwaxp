// test-fixture-reshuffle.mjs
// Script to test fixture reshuffling after week 36 (ESM)
import { getReshuffleCycle, generateShuffledFixtures } from './src/utils/matchGenerator.js';
